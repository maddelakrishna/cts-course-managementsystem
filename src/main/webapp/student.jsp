...
<form:form action="/student/stlogin" method="post" modelAttribute="student" style="margin-top:50px;">
...
New Student<a href="/student/register" style="color:yellow;"> SignUp</a>
</div>
